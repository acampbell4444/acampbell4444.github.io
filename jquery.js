...
//name page
	...
	$('#tankPic').click(function(){
		...
		if(tankPosit%4===0){
			...
			$('#box8').css({'background-color':'blue'}); $('#box4').css({'background-color':'coral'}).text("Bloccipedia").addClass('boxTitle');
			$('#box8, #box9, #box7').text("");
		...
		if(tankPosit%4===1){
			$("html, body").animate({scrollTop: 0}, 500); 
			$('#box4').css({'background-color':'blue'}).removeClass('boxTitle');  $('#box2').css({'background-color':'coral'}).addClass('boxTitle')
		...
		if(tankPosit%4===2){
			...
			$('#box2').css({'background-color':'blue'}).removeClass('boxTitle').text("");  $('#box6').css({'background-color':'coral'}).text("Guessing Game").addClass('boxTitle');
		...
		if(tankPosit%4===3){
			...
			$('#box6').css({'background-color':'blue'}).removeClass('boxTitle').text('');  $('#box8').css({'background-color':'coral'}).text("Bloccipedia").addClass('boxTitle');
